...
struct ContentView: View {
    ...
    @State public var symbols = ["eating", "love", "happy"]
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .center,spacing: 50) {
                ...
                VStack(spacing: 20) {
                    RoundedRectangle(cornerRadius: 20)
                        ...
                        .overlay(Text("Slots Remaining :  \(6-counter)")
                            .font(.title3)
                            .fontWeight(.bold)
            ...
            .alert(item: $ShowingAlert) { alert -> Alert in
                switch alert {
                case .success:
                    return Alert(title: Text("🥳Yaahhh!🥳\n you won!"),message: Text("Born with the charm"), dismissButton: .cancel())
                case .failure:
